...
import static pages.salesforce.enums.V3.TemplateTabV3Actions.LINK_TO_FILL;
...
public class PrefillTemplateTest extends SalesforceBaseTest {
    ...
    private String templateName = "Prefill";
    ...
    @Test
    public void fillPrefillTemplate() {
    ...
    @Test
    public void linkToFillPrefillTemplate() {
        SoftAssert softAssert = new SoftAssert();
        TemplatesPage templatesPage = daDaDocsFullApp.openTab(SaleforceMyDocsTab.TEMPLATES);
        templatesPage.selectDadadocsItemByFullName(templateName);
        LinkToFillCustomizeTab customizeTab = templatesPage.selectAnAction(LINK_TO_FILL.getAction());
    ...
    @Test
    public void sendToEachPrefillTemplate() {
        TemplatesPage templatesPage = daDaDocsFullApp.openTab(SaleforceMyDocsTab.TEMPLATES);
        templatesPage.selectDadadocsItemByFullName(templateName);
