...
public class ExpectedConditions {
    ...
    /**
     * Wrapper for a condition, which allows for elements to update by
     * redrawing.
     *
     * This works around the problem of conditions which have two parts: find an
     * element and then check for some condition on it. For these conditions it
     * is possible that an element is located and then subsequently it is
     * redrawn on the client. When this happens a
     * {@link StaleElementReferenceException} is thrown when the second part of
    ...
    public static <T> ExpectedCondition<T> refreshed(
        ...
        return new ExpectedCondition<T>() {
            ...
            @Override
            public String toString() {
                return String.format("condition (%s) to be refreshed",
                        condition);
            }
        };
    }
     ...
     * condition.
     */
    public static ExpectedCondition<Boolean> not(
    ...
    public static ExpectedCondition<Boolean> windowsNumber(final int size) {
        return new ExpectedCondition<Boolean>() {
            public Boolean apply(WebDriver driver) {
                return driver.getWindowHandles().size() == size;
            }
            @Override
            public String toString() {
                return "windows number " + size;
            }
        };
    }
