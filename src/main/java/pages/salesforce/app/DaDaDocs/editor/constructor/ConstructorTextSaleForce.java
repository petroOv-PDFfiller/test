...
import pages.pdffiller.editors.newJSF.constructor.ConstructorText;

import static core.check.Check.checkEquals;
import static core.check.Check.checkTrue;

public class ConstructorTextSaleForce extends ConstructorText {
    ...
    public ConstructorTextSaleForce(WebDriver driver) {
        super(driver);
    }

    public ConstructorTextSaleForce(WebDriver driver, NewJSFiller jsFiller) {
    ...
    public ConstructorTextSaleForce selectSalesForceFieldName(String name) {
    ...
    public ConstructorTextSaleForce selectObjectName(String name) {
        By textFieldName = By.xpath("//*[@aria-label='" + name + "']");
