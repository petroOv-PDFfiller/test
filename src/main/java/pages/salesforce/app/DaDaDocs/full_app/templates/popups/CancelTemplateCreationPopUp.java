...
import pages.salesforce.app.DaDaDocs.full_app.templates.tabs.x_templates.XTemplateInfoPage;
...
public class CancelTemplateCreationPopUp extends SalesforceBasePopUp {

    private By popUpHeader = By.xpath("//div[contains(@class, 'popup__header__')]//*[contains(@class, 'popup__title__')]");

    public CancelTemplateCreationPopUp(WebDriver driver) {
        super(driver);
    }
    ...
    public void isOpened() {
        ...
        checkEquals(getText(popUpHeader), "Cancel template creation?", "Wrong header for document delete popup");
    }

    @Step
    public <T extends SalesAppBasePage> T cancelCreation(boolean isV3) {
    ...
    @Step
    public XTemplateInfoPage continueCreation(boolean isV3) {
