...
public class DeleteProcessPopUp extends SalesforceBasePopUp {

    public DeleteProcessPopUp(WebDriver driver) {
        super(driver);
    }
    ...
    @Step
    public ProcessBuilderPage confirmDelete() {
        ...
        Logger.info("Confirm process deletion");
        ...
        ProcessBuilderPage page = new ProcessBuilderPage(driver);
        page.isOpened();
        return page;
    }
}
