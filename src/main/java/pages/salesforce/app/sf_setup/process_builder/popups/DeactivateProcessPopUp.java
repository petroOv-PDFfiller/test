...
public class DeactivateProcessPopUp extends SalesforceBasePopUp {

    public DeactivateProcessPopUp(WebDriver driver) {
        super(driver);
    }

    @Override
    public void isOpened() {
        checkTrue(isElementPresentAndDisplayed(popUpBody, 10), "Deactivate PopUp is not loaded");
    }

    @Step
    public ProcessBuilderEditorPage confirmDeactivation() {
        ...
        Logger.info("Confirm process deactivation");
